...
typedef struct tobii_lens_configuration_extended_per_eye_t
{
    float offset_mm_xyz[ 3 ];
    float intrinsic_rotation_deg_xyz[ 3 ];
} tobii_lens_configuration_extended_per_eye_t;

typedef struct tobii_lens_configuration_extended_t
{
    tobii_lens_configuration_extended_per_eye_t left;
    tobii_lens_configuration_extended_per_eye_t right;
} tobii_lens_configuration_extended_t;

TOBII_API tobii_error_t TOBII_CALL tobii_get_lens_configuration_extended( tobii_device_t* device,
    tobii_lens_configuration_extended_t* config);
TOBII_API tobii_error_t TOBII_CALL tobii_set_lens_configuration_extended( tobii_device_t* device,
    tobii_lens_configuration_extended_t const* config);

typedef enum tobii_lens_configuration_extended_writable_t
{
    TOBII_LENS_CONFIGURATION_EXTENDED_NOT_WRITABLE,
    TOBII_LENS_CONFIGURATION_EXTENDED_WRITABLE,
} tobii_lens_configuration_extended_writable_t;

TOBII_API tobii_error_t TOBII_CALL tobii_lens_configuration_extended_writable( tobii_device_t* device,
...
/**
@fn TOBII_API tobii_error_t TOBII_CALL tobii_get_lens_configuration_extended( tobii_device_t* device, tobii_lens_configuration_extended_t* lens_config );
@ingroup tobii_wearable
...
### Syntax
    ...
    #include <tobii/tobii_wearable.h>
    tobii_error_t TOBII_CALL tobii_get_lens_configuration_extended( tobii_device_t* device,
...
*lens_config* must be a pointer to a valid tobii_lens_configuration_extended_t. Upon success, it will be populated with the
relevant data. It will remain unmodified upon failure. It is a pointer to a struct containing the following data:
...
-   *left*
    ...
    -   *offset*
        An array of three floats, for the x, y and z offset of the left lens in the headset, given in millimeters.
    -   *rotation*
        An array of three floats, for the x, y and z intrinsic rotation of the left lens in the headset, given in degrees.

-   *right*
    This is another instance of the same struct as in *left*, but which holds data related to the right eye of the user.

The offset and the rotation are expressed in a right handed Cartesian coordinate system where:
X-axis positive direction is to the left when facing out through the lens.
Y-axis positive direction is towards the upper part of the HMD.
Z-axis positive direction is from the eye of the user towards the eye-tracker.

X rotation is a clockwise angle around the positive direction of the x-axis, known as pitch.
Y rotation is a clockwise angle around the positive direction of the y-axis, known as yaw.
Z rotation is a clockwise angle around positive direction of the z-axis, known as roll.
...
If the operation is successful, tobii_get_lens_configuration_extended() returns **TOBII_ERROR_NO_ERROR**. If the call
fails, tobii_get_lens_configuration_extended returns one of the following:
...
-   **TOBII_ERROR_CALLBACK_IN_PROGRESS**
    ...
    tobii_device_process_callbacks(), tobii_calibration_retrieve(), tobii_enumerate_illumination_modes(),
    or tobii_license_key_retrieve().
    Calling tobii_get_lens_configuration_extended from within a callback function is not supported.
...
/**
@fn TOBII_API tobii_error_t TOBII_CALL tobii_set_lens_configuration_extended( tobii_device_t* device, tobii_lens_configuration_extended_t const* lens_config );
@ingroup tobii_wearable
...
### Syntax
    ...
    #include <tobii/tobii_wearable.h>
    tobii_error_t TOBII_CALL tobii_set_lens_configuration_extended( tobii_device_t* device,
        tobii_lens_configuration_extended_t const* lens_config );
...
*lens_config* must be a pointer to a valid tobii_lens_configuration_extended_t. Upon success, the values have been written to the
tracker. They should correspond to the physical attributes of the headset that they represent.
...
-   **TOBII_ERROR_CALLBACK_IN_PROGRESS**
    ...
    tobii_device_process_callbacks(), tobii_calibration_retrieve(), tobii_enumerate_illumination_modes(),
    or tobii_license_key_retrieve().
    Calling tobii_set_lens_configuration_extended from within a callback function is not supported.
...
/**
@fn TOBII_API tobii_error_t TOBII_CALL tobii_lens_configuration_extended_writable( tobii_device_t* device, tobii_lens_configuration_extended_writable_t* writable );
@ingroup tobii_wearable
...
### Syntax
    ...
    #include <tobii/tobii_wearable.h>
    tobii_error_t TOBII_CALL tobii_lens_configuration_extended_writable( tobii_device_t* device,
        tobii_lens_configuration_extended_writable_t* writable );
...
*writable* must be a pointer to a valid tobii_lens_configuration_extended_writable_t.

On success, *writable* will be assigned a value that tells whether the tracker can write a new lens configuration.
**TOBII_LENS_CONFIGURATION_EXTENDED_WRITABLE** if it is writable and **TOBII_LENS_CONFIGURATION_EXTENDED_NOT_WRITABLE** if not.


### Return value

If the operation is successful, tobii_lens_configuration_extended_writable() returns **TOBII_ERROR_NO_ERROR**. If the call
fails, tobii_lens_configuration_extended_writable returns one of the following:
...
-   **TOBII_ERROR_CALLBACK_IN_PROGRESS**
    ...
    tobii_device_process_callbacks(), tobii_calibration_retrieve(), tobii_enumerate_illumination_modes(),
    or tobii_license_key_retrieve().
    Calling tobii_lens_configuration_extended_writable from within a callback function is not supported.
...
tobii_get_lens_configuration_extended(), tobii_set_lens_configuration_extended()
